...
} from '@livequery/discovery'

const OHAYO_API_GATEWAY = typeof process === 'undefined' ? '' : process.env.OHAYO_API_GATEWAY ?? ''
const OHAYO_DISCOVERY_KEY = typeof process === 'undefined' ? '' : process.env.OHAYO_DISCOVERY_KEY ?? ''
const OHAYO_DISCOVERY_PORT = typeof process === 'undefined' ? 12001 : Number(process.env.OHAYO_DISCOVERY_PORT ?? 12001)
